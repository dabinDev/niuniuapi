export default {
  ...
  nav: {
    ...
    studio: 'Studio',
    studioCover: 'Cover Generator',
    studioTeardown: 'Teardown Diagnosis',
    studioHotspot: 'Hit Benchmark',
    studioGenerate: 'Creative Generator',
    studioScript: 'Creative Generator',
    studioDownloader: 'Fanqie Hotlist',
    studioFanqieHotlist: 'Fanqie Hotlist',
    studioWorks: 'My Works',
    tokenClub: 'Token Club',
    systemManage: 'System',
  ...
  admin: {
    ...
    settings: {
      ...
      customMenu: {
        ...
        description: 'Add custom iframe pages to the sidebar navigation. They are admin-only by default and appear to users only after you enable user visibility.',
        ...
        userVisibleHint: 'Off by default. Regular users see this custom page only after an administrator enables and saves it.',
        add: 'Add Menu Item',
        remove: 'Remove',
        moveUp: 'Move Up',
        moveDown: 'Move Down',
  ...
  payment: {
    ...
    rechargePackages: 'Top-up Packages',
    rechargePackageCredit: 'Receive {credit}U',
    rechargePackageUnitPrice: 'Approx. ¥{price}/U',
    rechargePackageBestValue: 'Best value',
    rechargePackageSave: 'Save {percent}%',
    ...
    rechargeTierPreview: 'Top up CNY {amount} to receive {credit}U. Balance does not expire.',
    rechargeSubscriptionHintTitle: 'Power users save more with subscriptions',
    rechargeSubscriptionHintBody: 'Balance top-up is best for occasional extra usage and does not expire, but the unit price is higher. If you use the service every month, start with the subscription plans on the left: monthly quota costs less per U and larger plans include more bonus value.',
